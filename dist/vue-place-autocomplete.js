(function (global, factory) {
  ...
  var reIsNative$1 = RegExp('^' +
    funcToString$4.call(hasOwnProperty$11).replace(reRegExpChar$1, '\\$&')
  ...
  function hashHas$1(key) {
    var data = this.__data__;
    return _nativeCreate ? (data[key] !== undefined) : hasOwnProperty$13.call(data, key);
  }
  ...
  /** Built-in value references. */
  var propertyIsEnumerable$1 = objectProto$17.propertyIsEnumerable;
  ...
  var isArguments$1 = _baseIsArguments(function() { return arguments; }()) ? _baseIsArguments : function(value) {
    return isObjectLike_1(value) && hasOwnProperty$14.call(value, 'callee') &&
  ...
  function arrayLikeKeys$1(value, inherited) {
    ...
    for (var key in value) {
      if ((inherited || hasOwnProperty$15.call(value, key)) &&
          !(skipIndexes && (
  ...
  if (DataView$1 && getTag$1(new DataView$1(new ArrayBuffer(1))) != dataViewTag$5 || Map$1 && getTag$1(new Map$1()) != mapTag$6 || Promise$2 && getTag$1(Promise$2.resolve()) != promiseTag$1 || Set$1 && getTag$1(new Set$1()) != setTag$6 || WeakMap$1 && getTag$1(new WeakMap$1()) != weakMapTag$3) {
  ...
  function filter$2(collection, predicate) {
    var func = isArray(collection) ? arrayFilter$1 : baseFilter$1;
