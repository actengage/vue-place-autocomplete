(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue-interface/src/Helpers/Script'), require('vue-interface/src/Components/FormGroup'), require('vue-interface/src/Components/InputField'), require('vue-interface/src/Components/ActivityIndicator'), require('vue-interface/src/Plugins/MergeClasses')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue-interface/src/Helpers/Script', 'vue-interface/src/Components/FormGroup', 'vue-interface/src/Components/InputField', 'vue-interface/src/Components/ActivityIndicator', 'vue-interface/src/Plugins/MergeClasses'], factory) :
  (factory((global.VuePlaceAutocomplete = {}),global.script,global.FormGroup,global.InputField,global.ActivityIndicator,global.mergeClasses));
}(this, (function (exports,script,FormGroup,InputField,ActivityIndicator,mergeClasses) { 'use strict';
  ...
  InputField = InputField && InputField.hasOwnProperty('default') ? InputField['default'] : InputField;
  ActivityIndicator = ActivityIndicator && ActivityIndicator.hasOwnProperty('default') ? ActivityIndicator['default'] : ActivityIndicator;
